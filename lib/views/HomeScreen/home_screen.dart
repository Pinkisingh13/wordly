...
import 'package:wordly/model/word_detail.dart';
import 'package:wordly/model/word_model.dart';
import 'package:wordly/views/game.dart';
import 'package:wordly/views/game_over.dart';
import 'package:wordly/views/virtual_keyboard.dart';
    ...
    child:
        Container(
          ...
          decoration: BoxDecoration(
            ...
            // boxShadow: [
            //   BoxShadow(
            //     color: Color(0xff7886C7).withOpacity(0.5),
            //     blurRadius: 15,
            //     spreadRadius: 2,
      ...
      if (response.statusCode == 200) {
        ...
        if (data.isNotEmpty) {
          wordDetailsList =
              ...
              print("word Details List : ${wordDetailsList[0].meanings[0].definitions[1].example}");
